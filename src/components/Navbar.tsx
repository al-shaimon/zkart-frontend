      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center h-16 gap-4">
          ...
          <div className="hidden md:flex items-center gap-6 flex-shrink-0">
            ...
            {/* Categories Mega Menu using Popover */}
            <Popover open={isMegaMenuOpen} onOpenChange={setIsMegaMenuOpen}>
              <PopoverTrigger asChild>
                <button className="hover:text-gray-200 flex items-center gap-1 group">
            ...
            <Link href="/products" className="hover:text-gray-200 flex items-center gap-1">
              <Tag className="h-4 w-4" />
              Products
            </Link>
